...
export default function Hero() {
  return (
    <section className="relative h-screen bg-[#ebebeb] overflow-hidden">
      ...
      {/* Avatar — apparition depuis le bas (Motion) */}
      <div className="absolute bottom-0 left-1/2 -translate-x-1/2 z-10 h-[88%]">
        <motion.div
          className="h-full"
          initial={{ y: '110%' }}
          animate={{ y: 0 }}
